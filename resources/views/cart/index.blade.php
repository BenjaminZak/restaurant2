                                ...
                                @foreach (Cart::content() as $product)
                                    <tr>
                                        <th scope="row" class="border-0">
                                            <div class="p-2">
                                                <img src="{{ $product->model->image }}" alt="" width="200" height="250" class="img-fluid rounded shadow-sm">
                ...
                <div class="row py-5 p-4 bg-white rounded shadow-sm">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="p-4">
                            ...
                            </ul><a href="{{ route('checkout.index') }}" class="btn btn-dark rounded-pill py-2 btn-block">Passer ma commande</a>
                        </div>
                    </div>
                </div>
            </div>
